...
public class Setup
{
	...
	private List<LongToIntEntry> setupCards(IBackend backend) throws RemoteException
	{
...

		{
			...
			String description = "In seiner G¸te gew‰hrt dir Poseidon 2 zus‰tzliche Karten.";
		...
		}
		{
			...
			String name = "Thors St‰rke";
			String description = "Der Donnergott gew‰hrt einen Teil seiner St‰rke.";
			Long[] actionIds = { action.getId() };
		...
		}
		{
			...
			String description = "Der m‰chtige Panther verbreitet Furcht unter seinen Gegnern.";
			int attack = 7;
			int life = 9;
		...
		}
		{
			...
			String description = "Begehe nicht den Fehler diesen Drachen zu untersch‰tzen nur weil er noch klein ist.";
			int attack = 2;
			int life = 4;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
		...
		}
		{
			...
			String description = "Der Vater aller nordischen Gˆtter ist ein gef¸rchteter Krieger.";
			int attack = 10;
			int life = 10;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
		...
		}
		{
			...
			String description = "Dieses scheue bayrische Wesen verwirrt Gegner durch sein unnat¸rliches Aussehen.";
			int attack = 3;
			int life = 3;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
		...
		}
		{
			...
			String name = "Incubus";
			String description = "Der Incubus-D‰mon schw‰cht Gegner indem er Alptr‰ume verursacht.";
			int attack = 3;
			int life = 5;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
		...
		{
			Action action = heal4;
			String name = "Heilende H√§nde";
			String description = "Eine Ber¸hrung der magischen H‰nde reicht aus um alle kˆrperlichen Gebrechen zu heilen.";
			Long[] actionIds = { action.getId() };
		...
		}
		{
			...
			String description = "Der Schrumpfstrahler verkleiner jedes Ziel auf die H‰lfte der Grˆﬂe.";
			Long[] actionIds = { action.getId() };
		...
		}
		{
			...
			String name = "R¸bezahl";
			String description = "Der Berggeist R¸bezahl lauert seinen Feinden im tschechischen Riesengebirge auf.";
			int attack = 6;
			int life = 6;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
			...
			Long[] actionIds = actionIdsList.toArray(new Long[actionIdsList.size()]);
			BufferedImage bufferedImage = getImage("R¸bezahl.png");
			byte[] imageAsByteArray = ToByteArray(bufferedImage, "png");
			CardImage image = new CardImage(bufferedImage.getHeight(), 0l,
				DatatypeConverter.printBase64Binary(imageAsByteArray), 0.0f, 0.0f, "", "image/png",
				bufferedImage.getWidth());
	...
	private List<LongToIntEntry> createTutorialCards(IBackend backend) throws RemoteException
	{
		...
		List<LongToIntEntry> cards = new ArrayList<LongToIntEntry>();
		{
			...
			String description = "Gegen kleine und gro√üe magische Anh‰ngsel";
			Long[] actionIds = { action.getId() };
		...
		}
		{
			...
			String description = "Ein m‰chtiger Feuerball der alles auf seinem Weg verw¸stet";
			Long[] actionIds = { action.getId() };
		...
		}
		{
			...
			String description = "Ein besonders groﬂes Exemplar der Kobolde aus den fernen Mooren.";
			int life = 3;
			int attack = 3;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
		...
		}
		{
			...
			String description = "Eine uralte, riesige Eiche aus den Alpen-W‰ldern. Ger¸chteweise ein Verwandter von Baumbart";
			int attack = 2;
			int life = 10;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
		...
		}
		{
			...
			String description = "Die Stimme dieser Fee macht selbst aus w¸tenden Orks zahme Sch‰fchen.";
			int attack = 1;
			int life = 1;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
		...
		}
		{
			...
			String description = "Stiefel, S‰bel und Samt-Pfˆtchen: So kennen wir den gestiefelten Kater.";
			int attack = 2;
			int life = 2;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
		...
		}
		{
			...
			String description = "Diese Eule f¸rchtet sich vor nichts, weder vor dem J‰ger, noch dem Tageslicht. Vor garnichts!";
			int attack = 6;
			int life = 4;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
		...
		}
		{
			...
			String description = "Ein allezeit freundlicher und gut gelaunter G‰rtner-Zwerg der nur manchmal mit seiner Harke um sich schl‰gt.";
			int attack = 2;
			int life = 2;
			int stars = (int) (life * 0.5 + attack * 0.5);
			List<Long> actionIdsList = new ArrayList<Long>();
	...
	public void setupActions(IBackend backend) throws IOException
	{
		System.out.println("setupActions");
		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Der Spieler und andere Monster ohne Spott k√∂nnen nicht angegriffen werden solange dieses Monster am Feld ist.");
		...
		// StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
		// "Das Monster FÔøΩgt einem Gegner physischen Schaden zu");
		// StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Einschl√§fern 1");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Puts an enemy monster to sleep for one round. 1 time useable");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Schl√§fert ein gegnerisches Monster f√ºr eine Runde ein. 1 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Einschl√§fern 2");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Puts an enemy monster to sleep for one round. 2 times useable");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Schl√§fert ein gegnerisches Monster f√ºr eine Runde ein. 2 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Einschl√§fern 3");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Puts an enemy monster to sleep for one round. 3 times useable");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Schl√§fert ein gegnerisches Monster f√ºr eine Runde ein. 3 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Verwirrt ein gegnerisches Monster f√ºr zwei Runden. 1 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Verwirrt ein gegnerisches Monster f√ºr zwei Runden. 2 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Verwirrt ein gegnerisches Monster f√ºr zwei Runden. 3 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Schw√§chen 1");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Weakens (1/2) an enemy monster for two rounds. 1 times useable");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Schw√§cht ein gegnerisches Monster (1/2) f√ºr zwei Runden. 1 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Schw√§chen 2");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Weakens (1/2) an enemy monster for two rounds. 2 times useable");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Schw√§cht ein gegnerisches Monster (1/2) f√ºr zwei Runden. 2 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Schw√§chen 3");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Weakens (1/2) an enemy monster for two rounds. 3 times useable");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Schw√§cht ein gegnerisches Monster (1/2) f√ºr zwei Runden. 3 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Verbrennt ein gegnerisches Monster f√ºr zwei Runden, 3 Schaden pro Runde. 1 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Verbrennt ein gegnerisches Monster f√ºr zwei Runden, 3 Schaden pro Runde. 2 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Verbrennt ein gegnerisches Monster f√ºr zwei Runden, 3 Schaden pro Runde. 3 mal einsetzbar.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"F√ºgt einem Gegner 1 Punkt Schaden zu.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"F√ºgt einem Gegner 2 Punkt Schaden zu.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"F√ºgt einem Gegner 3 Punkt Schaden zu.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"F√ºgt einem Gegner 4 Punkt Schaden zu.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"F√ºgt einem Gegner 5 Punkt Schaden zu.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"F√ºgt einem Gegner 6 Punkt Schaden zu.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Schaden √úber Zeit 1");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Damages an enemy for 3 rounds, 2 Damage each round.");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"F√ºgt einem Gegner 3 Runden lang, 2 Schaden pro Runde zu.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Schaden √úber Zeit 2");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Damages an enemy for 2 rounds, 3 Damage each round.");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"F√ºgt einem Gegner 2 Runden lang, 3 Schaden pro Runde zu.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Schaden √úber Zeit 3");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Damages an enemy for 3 rounds, 3 Damage each round.");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"F√ºgt einem Gegner 3 Runden lang, 3 Schaden pro Runde zu.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Angriff erh√∂hen 1:1,5");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Increases attack of a monster by 1:1,5 Point.");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Erh√∂ht die Angriffspunkte eines Monsters um 1:1,5.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Angriff erh√∂hen 2");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Increases the attack of a monster by 2 points.");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Erh√∂ht die Angriffspunkte eines Monsters um 2.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
...

		{
			...
			StringToStringEntry deNameEntry = new StringToStringEntry("de", "Angriff erh√∂hen 4");
			StringToStringEntry[] namesEntries = { enNameEntry, deNameEntry };
			StringToStringEntry enDecriptionEntry = new StringToStringEntry("en",
				"Increases the attack of a monster by 4 points.");
			StringToStringEntry deDecriptionEntry = new StringToStringEntry("de",
				"Erh√∂ht die Angriffspunkte eines Monsters um 4.");
			StringToStringEntry[] descriptionEntries = { enDecriptionEntry, deDecriptionEntry };
