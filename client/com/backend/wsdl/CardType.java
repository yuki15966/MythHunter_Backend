...
public class CardType implements java.io.Serializable {
    ...
    public static final java.lang.String _MONSTER = "MONSTER";
    public static final java.lang.String _SPELL = "SPELL";
    public static final CardType MONSTER = new CardType(_MONSTER);
    public static final CardType SPELL = new CardType(_SPELL);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://backend.com/wsdl", "cardType"));
    }
    /**
